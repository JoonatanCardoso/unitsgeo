...
export function Contatos() {
    ...
    return (
        ...
        >
            <Grid item xs={12} md={12}  style={{ width: '100%', height: '400px', position: 'relative', overflow: 'hidden' }}>
                <a href="https://maps.app.goo.gl/cfPZopzhS9yjKxbN7" target="_blank" rel="noreferrer">
                    <Image
            ...
            <Grid padding={2} item xs={12} md={3}>
                <Image
                    src="/logo.png"
                    alt="Logo UnitsGeo"
                    priority={true}
            ...
            <Grid className={styles.itemsContainer}>
                <Grid padding={2} item xs={12} md={3}>
                    <Typography className={styles.title} color='black' variant='h6' component="h6">
                        Contato
                    </Typography>
